...
final class RegisterControllerClassMethodDecoratorPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        foreach ($container->findTaggedServiceIds(ApiBundle::CONTROLLER_CLASS_METHOD_DECORATOR_TAG) as $id => $tags) {
            $container
